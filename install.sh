...
wget --no-check-certificate "https://raw.githubusercontent.com/wrtx/panelwarp/main/warp.sh" -O /usr/bin/warp && chmod +x /usr/bin/warp
clear
echo -e "Installasi WARP selesai"
echo -e "Memulai installasi Auto Reboot VPS"
echo -e "Downloading Binaries Files"
sleep 2
wget --no-check-certificate "https://raw.githubusercontent.com/wrtx/panelwarp/main/auto-reboot.sh" -O /root/auto-reboot.sh && chmod +x /root/auto-reboot.sh
clear
...
wget --no-check-certificate "https://raw.githubusercontent.com/wrtx/panelwarp/main/speedtest" -O /usr/bin/speedtest && chmod +x /usr/bin/speedtest
clear
